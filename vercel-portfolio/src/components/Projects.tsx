...
const projects: Project[] = [
  ...
  },
  {
    ...
    tagline: 'Benchmarking chunking, retrieval, and grounded generation',
    description: 'Experimentation platform for RAG systems with declarative YAML configs, isolated Pinecone namespaces, LLM-generated benchmark data, cost tracking, and an evaluation path designed to compare retrieval strategies instead of relying on one-off demos.',
    achievements: [
      'Generated a 1,054-pair English benchmark from a 34-page corpus with semantic deduplication and versioned artifacts.',
      'Executed 4 end-to-end RAG configurations over the same dataset to isolate chunking and retrieval trade-offs.',
      'Tracks tokens, cost, and experiment outputs to make evaluation and operational trade-offs inspectable.',
    ],
    whyItMatters: 'This is AI engineering beyond prompt demos: benchmark design, retrieval experimentation, cost observability, and evaluation discipline around grounded answers.',
    tech: ['OpenAI', 'Pinecone', 'Pydantic', 'MLflow', 'YAML', 'Pytest'],
    githubUrl: 'https://github.com/MaiconKevyn/rag-eval-lab',
    gradient: 'from-sky-500 to-emerald-500',
    accent: '#38bdf8',
    signal: { label: 'Benchmark QA pairs', display: '1054' },
    image: '/images/rag-eval-lab-card.svg',
  },
];
